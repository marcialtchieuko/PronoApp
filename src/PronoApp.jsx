...
const STRINGS = {
  fr: {
    ...
    subscribeSubEurope: "Paiement par carte bancaire.",
    subscribeSubAfrica: "Paiement par Mobile Money ou Orange Money.",
  ...
  en: {
    ...
    subscribeSubEurope: "Payment by bank card.",
    subscribeSubAfrica: "Payment by Mobile Money or Orange Money.",
    ...
    demoNote:
      "Demo: tapping a plan instantly activates VIP in this prototype. In production, this button will open real Flutterwave payment (Mobile Money / Orange Money in Central Africa, bank card in Europe), and VIP will only activate once payment is confirmed.",
