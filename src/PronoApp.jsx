    ...
    <div className="app-root">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .payment-banner.checking { background: rgba(47,128,237,0.1); color: var(--blue-dark); }
        .payment-banner.success { background: rgba(39,174,96,0.12); color: #1B7A43; }
        .payment-banner.pending { background: rgba(245,166,35,0.12); color: #8A5A05; }
        .payment-banner.failed { background: rgba(229,83,61,0.12); color: #B23A28; }
                    ...
                    <>
                      ...
                      <div className="settings-group">
                        ...
                        <div
                          ...
                          style={{ cursor: "pointer" }}
                          onClick={() =>
                            (window.location.href = "mailto:pronoapp.contacts@gmail.com?subject=Contact%20PronoApp")
                          }
                        >
                          <span className="settings-row-left">
                            <span className="settings-row-icon">
