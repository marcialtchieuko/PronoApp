...
const STRINGS = {
  fr: {
    ...
    demoNote:
      "Démo : ici, cliquer sur un plan active le VIP instantanément dans ce prototype. En production, ce bouton ouvrira le paiement NotchPay réel sur une page sécurisée (Mobile Money, Orange Money, MTN ou carte bancaire selon votre pays), et le VIP ne s'activera qu'après confirmation du paiement. Chaque achat est manuel, sans renouvellement automatique.",
  ...
  en: {
    ...
    demoNote:
      "Demo: tapping a plan instantly activates VIP in this prototype. In production, this button will open real NotchPay payment on a secure page (Mobile Money, Orange Money, MTN, or bank card depending on your country), and VIP will only activate once payment is confirmed. Each purchase is manual, with no auto-renewal.",
